"""
Pandaone AI Agent — AI Agent 代码审计门禁系统

主包入口:
  - CLI:    pandaone <command> [args]
  - Module: python -m pandaone <command> [args]
  - API:    from pandaone import main; main()
...
# ---------------------------------------------------------------------------
# 版本号: 单一事实源 = METADATA
#   - 正常安装(pip install *.whl): importlib.metadata.version("pandaone-guard")
