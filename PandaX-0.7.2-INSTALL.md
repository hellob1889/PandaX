...
├── dist/
│   ├── pandax_guard-0.7.2-py3-none-any.whl   (70 KB, 推荐安装方式)
│   └── pandax_guard-0.7.2.tar.gz             (146 KB, 源码包)
└── PandaX-0.7.2-INSTALL.md             (本文件)
```
